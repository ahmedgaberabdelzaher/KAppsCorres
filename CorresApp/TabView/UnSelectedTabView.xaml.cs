...
{
    public partial class UnSelectedTabView : ContentView
    {
        public UnSelectedTabView()
        {
            InitializeComponent();
        }
        ...
        {
            var control = bindable as UnSelectedTabView;
        ...
        public static readonly BindableProperty TitleTextProperty = BindableProperty.Create(
                                                        ...
                                                        declaringType: typeof(UnSelectedTabView),
                                                        defaultValue: "",
        ...
        {
            var control = (UnSelectedTabView)bindable;
